...
@Table(name = "dim_payment_order_status", schema = "bclient", uniqueConstraints = {
    @UniqueConstraint(columnNames = "payment_order_status_code", name = "uk_payment_order_status_code")})
@Entity
